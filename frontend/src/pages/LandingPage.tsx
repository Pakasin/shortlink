...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    // ✅ โหลด user name จาก localStorage
  ...
  // ✅ FIX 2: ใช้ key "token" ให้ตรงกัน
  const handleLogout = () => {
    localStorage.removeItem("token");   // ✅ แก้จาก "auth_token" → "token"
            ...
            {!isLoggedIn ? (
              ...
              <>
                ...
                <div style={{ position: "relative" }}>
                  <button onClick={() => setShowUserMenu(!showUserMenu)} style={{ width: 38, height: 38, borderRadius: "50%", background: "linear-gradient(135deg,#3b82f6,#1d4ed8)", border: "2px solid rgba(59,130,246,0.4)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "white" }}>
                    <User size={16} />
                  </button>
                  {showUserMenu && (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
            <div className="card-lift" style={{ ...glassCard, gridColumn: "span 2", padding: 40, minHeight: 320, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <p style={{ color: "#64748b", fontSize: 14, lineHeight: 1.75, maxWidth: 400 }}>
                  Deep-dive into your link performance with real-time data and insights.
                </p>
              </div>
            ...
            <div className="card-lift" style={{ ...glassCard, padding: 40, minHeight: 320, display: "flex", flexDirection: "column", justifyContent: "space-between", background: "linear-gradient(135deg,rgba(124,58,237,0.25) 0%,rgba(109,40,217,0.14) 100%)", borderColor: "rgba(167,139,250,0.18)" }}>
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.55)", fontSize: 14, lineHeight: 1.75 }}>
                  Generate and update QR codes dynamically without reprinting.
                </p>
              </div>
            ...
            <div className="card-lift" style={{ ...glassCard, gridColumn: "span 2", padding: 40, display: "flex", alignItems: "center", gap: 32, background: "linear-gradient(135deg,rgba(30,41,59,0.95),rgba(15,23,42,0.95))" }}>
              <div style={{ flex: 1 }}>
                ...
                <h3 style={{ fontFamily: "'Manrope',sans-serif", fontWeight: 700, fontSize: 20, marginBottom: 12 }}>Enterprise Security</h3>
            ...
            <div className="card-lift" style={{ ...glassCard, padding: 32 }}>
              ...
              <p style={{ color: "#64748b", fontSize: 14, lineHeight: 1.75 }}>
                Track every click and optimize your campaigns in real time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
              {[{ icon: <Filter size={22} color="#3b82f6" />, title: "Advanced Filtering", desc: "Filter by date, device, region, and referral source." }, { icon: <Download size={22} color="#3b82f6" />, title: "Export Reports", desc: "Download CSV or PDF reports for any date range." }, { icon: <Bell size={22} color="#3b82f6" />, title: "Smart Alerts", desc: "Get notified when clicks spike or drop unexpectedly." }, { icon: <Share2 size={22} color="#3b82f6" />, title: "Team Sharing", desc: "Share analytics dashboards with your whole team." },].map(f => (
